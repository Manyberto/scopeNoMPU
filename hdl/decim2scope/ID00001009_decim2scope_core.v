...
assign decim_factor 	= { {ADDR_WIDTH-3{1'd0}}, 3'd4};//config_reg[ADDR_WIDTH-1 -: ADDR_WIDTH];
assign size2decim 	= { {ADDR_WIDTH-10{1'd0}}, 10'd512}; //{config_reg[ADDR_WIDTH*2-1 -: ADDR_WIDTH];
